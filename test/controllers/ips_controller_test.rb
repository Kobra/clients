...
class IpsControllerTest < ActionController::TestCase
  ...
  test "should create ip" do
    assert_difference('Ip.count') do
      post :create, ip: { client_id: @ip.client_id, comments: @ip.comments, net: @ip.net, p2p: @ip.p2p, uid: @ip.uid }
    end
  ...
  test "should update ip" do
    patch :update, id: @ip, ip: { client_id: @ip.client_id, comments: @ip.comments, net: @ip.net, p2p: @ip.p2p, uid: @ip.uid }
    assert_redirected_to ip_path(assigns(:ip))
  end
